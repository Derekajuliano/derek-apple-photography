...
5. Do **not** add a `wrangler.toml` file for this repo's Git-based Cloudflare Pages deployment; let Pages use the dashboard build settings and default `functions/` auto-discovery.
